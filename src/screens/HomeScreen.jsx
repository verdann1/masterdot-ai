import { Download, Gauge, Zap, GanttChartSquare, Users, BarChart3 } from "lucide-react";
      ...
      <div className="mp-card-highlight rounded-[32px] p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            <p className="text-[11px] font-bold uppercase tracking-widest text-cyan-400/80">MetaPulse</p>
          ...
          <div className="rounded-2xl p-3" style={{ background: "rgba(6,182,212,0.1)", boxShadow: "0 0 20px rgba(6,182,212,0.12), inset 0 1px 0 rgba(6,182,212,0.12)" }}>
          ...
          <div className="h-3 overflow-hidden rounded-full bg-slate-800/80">
            <div
              ...
              style={{
                ...
                boxShadow: percent > 0 ? "0 0 12px rgba(6,182,212,0.4)" : "none",
              }}
            />
          </div>
        </div>
        ...
        <div className="mt-4 flex gap-2">
          <button
            ...
            className="flex h-11 flex-1 items-center justify-center gap-2 rounded-2xl text-sm font-bold text-white active:opacity-80"
            style={{ background: "linear-gradient(135deg, #22d3ee 0%, #06b6d4 50%, #0891b2 100%)", boxShadow: "0 4px 16px rgba(6,182,212,0.35)" }}
          >
      ...
      <div className="relative">
        ...
        <div className="mt-2 grid grid-cols-3 gap-2">
          <button
            ...
            className="flex items-center justify-center gap-1.5 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 py-2.5 text-xs font-semibold text-cyan-400 active:opacity-70"
          >
